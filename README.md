# 基于Python+Django+Vue的医院预约医院预定推荐系统设计与实现
...
前台地址： [https://dvyiyuan.ake999.com](https://dvyiyuan.ake999.com)

后台地址：https://dvyiyuan.ake999.com/login
...
- 后台功能包括：首页、轮播图管理、管理员、医院管理、个人管理、医生管理、订单管理、地址管理
- 付费功能（收藏管理，评论管理，医生审核，评论审核，协同过滤算法推荐）

### 代码结构

- django_vue_yiyuan目录是后端代码
- django_vue_yiyuan_front目录是前端代码
...
进入django_vue_yiyuan_front目录下，安装依赖，执行:
